...
Personnage::Personnage() : Listable(), x(0), y(0), xdep(0), ydep(0), xdepold(0), 
ydepold(0), vie(1), viemax(1), invincible(0), type(0), direction(S), h(0), w(0), 
anim(0), animmax(0) {
    image = NULL;
...
void Personnage::setW(int i) {w=i;}
void Personnage::setH(int i) {h=i;}
...
void Personnage::setInvincible(int i) { invincible = i;}
